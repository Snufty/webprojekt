        ...
        <v-row no-gutters>
            <v-col offset-md="1" md="5">
                ...
                <div id="info" class="pa-2">
                    <v-text-field label="Bagel Name" required v-model="name"></v-text-field>
                    ...
                    <v-btn color="success" class="mr-2" flat @click="addNewMenuItem()">Add Item</v-btn>
...
<style lang="scss" scoped>
    ...
    h1 {
    @include infobox_mixin(5px, map-get($colorz, hvid), 10px, 5px, map-get($colorz, hvid));
    font-weight: bold;
